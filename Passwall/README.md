# Passwall 使用教程（对齐 Clash Party v5.4.21 简化版）

> 配置参考：`Passwall/` 目录  
> 版本：**v5.4.21-pw.1**（Build 2026-05-31；含借鉴 Proxy-override 批 A #2 国内 SDK/CDN 直连 + 批 D #4 版本对齐；Passwall 不承载 DNS resolver，N/A）

# v2rayN 使用教程（对齐 Clash Party v5.4.15）

> 路径 C（Xray 核）产物：`v2rayN/v2rayN(xray).json` v5.4.15-v2n.1（详见 `v2rayN/CHANGELOG.md`；同步 GEOSITE 覆盖台账元数据，并保留 Cloudflare R2 前置规则）。

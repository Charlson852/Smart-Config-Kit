# v2rayN 使用教程（对齐 Clash Party v5.4.21）

> 路径 C（Xray 核）产物：`v2rayN/v2rayN(xray).json` v5.4.21-v2n.1（详见 `v2rayN/CHANGELOG.md`；含借鉴 Proxy-override 批 A #2 国内 SDK/CDN 直连；#4 DoH N/A；Xray 路由 JSON 不承载 DNS 解析，mihomo / sing-box 路径复用对应产物）。

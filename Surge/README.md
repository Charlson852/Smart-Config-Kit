# Surge 使用教程（对齐 Clash Party v5.4.12）

> 配置文件：`Surge/Surge.conf`
> 版本：**v5.4.12-Surge.1**（Build 2026-05-12，详见 `Surge/CHANGELOG.md`；RustDesk Mac 进程走会议协作，域名兜底前置于 Copilot）
...
1. Surge → **首页** → **已启用的配置**：应显示 `Surge Smart v5.4.12-Surge.1`。

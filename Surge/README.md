# Surge 使用教程（对齐 Clash Party v5.4.13）

> 配置文件：`Surge/Surge.conf`
> 版本：**v5.4.13-Surge.1**（Build 2026-05-19，详见 `Surge/CHANGELOG.md`；补齐 STUN/TURN 标准端口直连，QUIC 策略不变）
...
1. Surge → **首页** → **已启用的配置**：应显示 `Surge Smart v5.4.13-Surge.1`。

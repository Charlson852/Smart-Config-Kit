...
> 当前版本：**v5.4.21-cmfa.1**（跟随 Clash Party v5.4.21 主线；含借鉴 Proxy-override 批 A+B+D：国内 SDK/CDN 直连 + fake-ip-filter 补全 + direct-nameserver-follow-policy + 节点过滤 junk 关键词补充 + DoH-over-IP bootstrap）

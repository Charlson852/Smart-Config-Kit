# Quantumult X 使用教程（对齐 Clash Party v5.4.17）

> 配置文件：`Quantumult X/QuantumultX.conf`
> 版本：**v5.4.17-QX.1**（Build 2026-05-26，详见 `Quantumult X/CHANGELOG.md`；DNS split-bootstrap 按 QX 原生字段映射，DoH 顺序 AliDNS 优先）

...
> 当前版本：**v5.4.17-flclash-verge-dns.1**（22 url-test 区域组 + 32 业务策略组；DNS 按 clash-verge-script 模型：默认国外 DoH，CN/private 走国内 DoH）
...
3. 输入名称（如 `Smart分流`），选择加载方式：
   - **URL**：填入 `https://raw.githubusercontent.com/Charlson852/Smart-Config-Kit/refs/heads/fix/verge-style-dns/FlClash/FlClash%28mihomo%29.js`

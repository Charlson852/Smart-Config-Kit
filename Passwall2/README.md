# Passwall / Passwall2 使用教程（对齐 Clash Party v5.4.14 简化版）

> 配置参考：`Passwall2/` 目录  
> 版本：**v5.4.14-pw2.1**（Build 2026-05-20；显式补齐 Cloudflare R2 存储域，Sukka phishing 源在 Passwall2 shunt_rules 中不适用）

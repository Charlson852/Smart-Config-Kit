# Passwall / Passwall2 使用教程（对齐 Clash Party v5.4.17 简化版）

> 配置参考：`Passwall2/` 目录  
> 版本：**v5.4.17-pw2.1**（Build 2026-05-26；DNS split-bootstrap 不适用于 Passwall2 shunt_rules，Paddle / Cloudflare R2 规则保持）
